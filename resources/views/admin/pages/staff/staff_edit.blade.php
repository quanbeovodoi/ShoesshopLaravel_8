                ...
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb page-title">
                            <li class="breadcrumb-item"><a href="{{URL::to('./')}}">SHOES</a></li>
            ...
            <div class="row">
                    <div class="col-lg-4 col-xl-4">
                        <div class="card-box text-center">
                            ...
                            @else
                            <img src="{{URL::asset('public/backend/images/users/avatar.svg')}}" class="rounded-circle avatar-xl img-thumbnail" alt="profile-image">
                            @endif
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        @else
                                                        <img class=" mt-3" width="100px" height="100px" id="image" src="{{URL::asset('public/backend/images/users/avatar.svg')}}" />
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
